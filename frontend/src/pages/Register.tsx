  ...
  return (
    <div className="w-full h-full flex justify-center items-center overflow-x-hidden relative">
      <div className="w-[370px] h-[470px] rounded-[15px] border-1 shadow-all border-white flex flex-col items-center py-[10px] px-[25px]">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full h-full flex flex-col gap-[19px] mt-[58px] items-center">
          ...
          <Button type="submit" variant={"ghost"} className="border-[1px] border-white w-max px-[30px] mt-[65px]">Создать</Button>
        </form>
        <div className="w-[320px] h-[0.3px] bg-[#C2C2C2] mt-[10px]"></div>
        <div className="flex gap-[10px] mt-[10px]">
          <p>do you have an account?</p>
          <Link to="/login" className="text-[#7D7FCF]">login...</Link>
        </div>
      </div>
    </div>
  );
